  ...
  <div class="card">
    ...
    <div id="collapseCS301" class="collapse" aria-labelledby="headingCS301" data-parent="#accordionY3misc">
      <div class="card-body">
        <large class="text-muted">25/26</large>
        <br/>
        This module is for those whose enjoyed the computational tractability section in CS260 and Cook (Turing) reductions in CS259. Initially, you will cover properties of Turing machines, Cook reductions, and NP-Completeness (which most of which you will be familiar with, given that you have done the two modules mentioned here). Then, you will look into co-NP and PSPACE problems (PSPACE you may have touched the surface of in CS260), which I felt up to this point it was not too difficult to understand. You will then move on to randomised complexity, where you cover the complexity classes RP, BPP, ZP, etc. This section in particular will require a lot more focus and understanding. This is followed by communication complexity, which acted like a nice change within the environment. Finally, we end with approximation complexity, which acts as a nice stepping stone for <it>CS356 Approximation and Randomised Algorithms</it>. Overall, I did find the module quite challenging (especially the tutorial sheets). The exam is half and half. If you have fully enganged with the content and have been practicing the questions during the second term, you will be fine. 
      </div>
    </div>
    <!-- -->
    ...
    <div id="collapseCS356" class="collapse" aria-labelledby="headingCS356" data-parent="#accordionY3misc">
      <div class="card-body">
        <large class="text-muted">25/26</large>
        <br/>
        This module is awesome. It is taught in two halves: Approximation algorithms, and Randomised algorithms, in which both sections were taught really well. The approximation algorithms section covers approximation ratios for minimisation and maximisation problems. You will also cover duality fitting, which is a technique used when converting a problem into a linear program. You will also dive into asymptotic approximation ratios (which is the challenging and fun part of this section). In the randomised algorithm, you will need to use your skills from <it>ST120</it>, given that there will be a huge emphasis on probability (and expectation). This section I felt was more difficult than the previous section, but was very interesting. If you want to ace this module, just keep up with the content as much as you can. Practice the tutorial sheets and attend the seminars, and you will have a nice time regarding exam prep. I highly recommend people to take this module if they enjoy theoretical computer science. 
      </div>
    </div>
    <!-- -->
